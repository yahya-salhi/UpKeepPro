    ...
    <aside className="hidden lg:block my-4 mx-2 w-80 max-w-xs">
      <div className={`${
        ...
        <div className="relative">
          <div className={`absolute inset-0 ${isDarkMode ? "bg-indigo-600/10" : "bg-indigo-500/5"} mix-blend-overlay`}></div>
          <h2 className={`font-bold text-center text-xl py-5 tracking-tight ${isDarkMode ? "text-white" : "text-slate-800"} font-['Roboto','Inter','sans-serif'] relative`}>
            Who to follow
        ...
        <div className="flex flex-col gap-3 p-4">
            ...
            suggestedUsers?.map((user) => (
              ...
              >
                <div className="flex gap-3.5 items-center min-w-0">
                  <div className="relative">
                    <div className={`w-11 h-11 rounded-full ring-2 ${
                      isDarkMode 
                  ...
                  <div className="flex flex-col min-w-0">
                    <span className={`font-semibold ${isDarkMode ? "text-zinc-100" : "text-slate-800"} truncate max-w-[7.5rem] first-letter:capitalize text-base leading-tight`}>
                      {user.grade}{" "}
          ...
          {!isLoading && suggestedUsers?.length === 0 && (
            <div className="py-6 text-center">
              <p className={`${isDarkMode ? "text-zinc-400" : "text-slate-500"} text-sm`}>
